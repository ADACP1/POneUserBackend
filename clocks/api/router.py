...
from clocks.api.views import ClockCreateView,ClockListView,LastClockView,AbsenceTypeByCompanyListView,AbsenceTypeView,AbsenceTypeListView,AbsenceEmployeeListView,AbsenceEmployeeCreateView
urlpatterns = [
